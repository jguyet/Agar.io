...
import com.weoohh.agar.client.receivedmessage.DataProcessor;
import com.weoohh.agar.utils.ToUnicode;
import com.weoohh.agar.utils.WebSocketCryptage;
		...
		while(Start.isRunning)
    	{
    		...
    		if(message != null && !message.isEmpty())
	    	{
    			...
    			if (message != null && StringUtils.isAsciiPrintable(message))
    			{
	    			...
	    			processor.postProcess(json, client);
    			}
	    		message = "";
	    	}
    	}
